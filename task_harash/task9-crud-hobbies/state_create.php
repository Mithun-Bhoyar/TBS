...
if(isset($_POST['save']))
{
	...
	$errors = validate_create_state();
		
	if(empty($errors))
	{
		$checkstatesname=mysqli_fetch_assoc(mysqli_query($conn,"SELECT statename FROM states WHERE statename='".$_POST['statename']."'"));

		
		
		if(!empty($checkstatesname))
		{
			$errors['statename']= "state already exist ";
		}
		else
		{
			$insertstates = "INSERT INTO states set 
			...
			if(mysqli_query($conn,$insertstates))
			{
				unset($_POST);
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="alert alert-danger">
						<?php echo "Unable to create country please try again"; ?>
					</div>
					<?php } ?>

					<div class="panel-heading  panel-primary">
						<h4 class="panel-title">Create state</h4>
					</div>
					<br />
					<div class="col-md-12">
