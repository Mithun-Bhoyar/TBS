...
if(isset($_POST['save']))
{
	...
	require_once("includes2/validations2.php");
									...
									<table cellpadding="0px" cellspacing= "0px" border = "0" align ="center" width ="340px" >
										...
										<tr>
											<td colspan="2" class="sec">
												<label>Field Label (?)<span> * </span></label><span class="text text-danger"> <?php echo(isset($errors['fieldlabel']))?$errors['fieldlabel']:'';?></span><br/>
												<textarea rows="2" class="text1" name="fieldlabel"><?php echo(isset($_POST['fieldlabel']))?$_POST['fieldlabel']:'';?></textarea>
											</td>
										</tr>
										<tr>
											<td class="sec">
												<label>Field type (?)<span> * </span></label><span class="text text-danger"> <?php echo(isset($errors['fieldtype']))?$errors['fieldtype']:'';?></span><br/>
											...
											<td class="sec">
												...
												<span class="text text-danger"> <?php echo(isset($errors['dateformat']))?$errors['dateformat']:'';?></span><br/>
