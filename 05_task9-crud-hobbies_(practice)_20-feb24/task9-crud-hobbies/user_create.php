	...
	if(empty($errors))
	{
		...
		else
		{
			...
			if(mysqli_query($conn,$insertUser))
			{
				...
				//header("Location: user_manage.php?success =true"); 
				//exit;
			} 
			else 
			{
					...
					<div class="panel-body">
						<?php 
							...
							{ ?>
								...
								echo "<script>setTimeout(\"location.href = 'http://localhost/TBSphpmysql/05_task9-crud-hobbies_Login(practice)_20-feb24/task9-crud-hobbies/user_manage.php';\",1500);</script>";?></div>
							<?php } ?>
							<?php 
