				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<?php 
							...
							{ ?>
								<div class="alert alert-success"><?php echo "Hobby has been created successfully";
								echo "<script>setTimeout(\"location.href = 'http://localhost/TBSphpmysql/05_task9-crud-hobbies_Login(practice)_20-feb24/task9-crud-hobbies/hobby_manage.php';\",1500);</script>"; // it prints the message "
								?></div>
							<?php } ?>
							<?php 
